...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("75302f13-0b7e-5bab-a6d1-23fa92e4c2ea"))
...
if best_platform === nothing
    @debug("Unable to load Graphene; unsupported platform $(triplet(platform_key_abi()))")
else
