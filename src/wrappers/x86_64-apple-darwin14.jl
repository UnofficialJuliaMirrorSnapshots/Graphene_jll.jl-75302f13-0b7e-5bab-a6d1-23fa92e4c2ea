# Autogenerated wrapper script for Graphene_jll for x86_64-apple-darwin14
export libgraphene
...
const libgraphene_splitpath = ["lib", "libgraphene-1.0.0.dylib"]
...
const libgraphene = "@rpath/libgraphene-1.0.0.dylib"
