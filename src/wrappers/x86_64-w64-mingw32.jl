# Autogenerated wrapper script for Graphene_jll for x86_64-w64-mingw32
export libgraphene
...
const libgraphene_splitpath = ["bin", "libgraphene-1.0-0.dll"]
...
const libgraphene = "libgraphene-1.0-0.dll"
